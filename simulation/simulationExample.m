...
% =========================================================================
maxWl = 1540/10e6; % Maximum wavelength
...
%transducer.position = round([1, Ny/2 - transducer_width/2, 1]);
...
scattering_map = scattering_map_mean + scattering_map_std * randn([Nx_tot, Ny_tot, Nz_tot]);
% define properties
scattering_c0 = c0 * ones(Nx_tot, Ny_tot, Nz_tot) .* scattering_map;
scattering_rho0 = rho0 * ones(Nx_tot, Ny_tot, Nz_tot) .* scattering_map;
