...
resultsDir = 'C:\Users\sebas\Documents\Data\Attenuation\UFFC2024Results\mama';

tableName = 'clinical.xlsx';
T = readtable('breast.xlsx');
...
dataTable = array2table(dataCols,...
    ...
    'mama-TV-mean','mama-TV-std', ...
    'mama-SWTV-mean','mama-SWTV-std', ...
    'mama-SWIFT-mean','mama-SWIFT-std', ...
    });
