...
%%
results1 = struct2table(MetricsSWIFT);
results2 = struct2table(MetricsSWIFT2);
results3 = struct2table(MetricsWFid);
results4 = struct2table(MetricsWReg);
