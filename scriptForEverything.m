...
setup,
baseDir = 'C:\Users\sebas\Documents\Data\Prociencia2020';
% baseDir = 'LiverAcquisition_24_09_07';


sampleDir = fullfile(baseDir,'vessels');
...
xlabel(ax1,'Lateral [cm]'), ylabel(ax1,'Axial [cm]')
xlim([-9 9]), ylim([0 18])
exportgraphics(gcf,fullfile(figsDir,"sample"+samName+"_Bm2.png"), ...
    'Resolution','300')
